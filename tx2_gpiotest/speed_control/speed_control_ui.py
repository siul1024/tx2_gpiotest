...
class Main_Control(QtWidgets.QWidget):
    def __init__(self):
        QtWidgets.QWidget.__init__(self)
        self.ui = uic.loadUi("MainWindow.ui")
        self.ui.show()

        self.v_speed = 0    # 회전 방향 default
        ...
        self.ui.btn_a.clicked.connect(self.sp_l)    # alt + a 입력시 회전 방향 -
    ...
    def Status(self):   # 상태 표시
        ...
        if (self.v_speed < 0):  # 회전 방향 및 수치 표시
